...
public class HaircutRecyclerviewAdapter extends RecyclerView.Adapter{
    private Context mContext;
    private int mLayout;
    private List<HairStyle> hairs;
    private MyItemClickListener mItemClickListener;

    public HaircutRecyclerviewAdapter(Context mContext, int mLayout, List<HairStyle> hairs) {
...
//            simpleDraweeView = (SimpleDraweeView) itemView.findViewById(R.id.user_main_perm_simpledraweeview);
            hairstyleimg = itemView.findViewById(R.id.user_main_haircut_img);
            hairstylename = itemView.findViewById(R.id.user_main_haircut_hairstylename);
