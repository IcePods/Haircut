...
public class LooperTextView extends FrameLayout {
    ...
    private static final String TIP_PREFIX = "刚刚预约了 ";
    ...
    private void initTipFrame() {
        head_boy = loadDrawable(R.mipmap.user_person_head_cat_img);
        head_girl = loadDrawable(R.mipmap.user_person_head_cat_img);
