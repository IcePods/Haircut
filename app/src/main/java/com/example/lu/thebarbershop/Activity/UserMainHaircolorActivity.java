...
public class UserMainHaircolorActivity extends AppCompatActivity {
    private RecyclerView mRecyclerView;
    private RecyclerView.LayoutManager mLayoutManager;
    private HaircolorRecyclerviewAdapter mAdapter;
    private ImageButton backbutton;//返回按钮 id=user_main_haircolor_back_imgbtn
    private TextView hairnametxt;//顶部发型类型名称 id=user_main_haircolor_name
        ...
        public void handleMessage(Message msg) {
            switch (msg.what){
                case 1:
                    ...
                    Log.i("index",perms);
                    Gson gson1 = new Gson();
                    colorlist=gson1.fromJson(perms,new TypeToken<List<HairStyle>>(){}.getType());
                    Log.i("index",colorlist.get(1).getHairstyleName()+"");
                    initAdapter();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_user_main_haircolor);
        postGetHairStyleByType("染发",1);
        //获取控件id
        backbutton = findViewById(R.id.user_main_haircolor_back_imgbtn);
        hairnametxt = findViewById(R.id.user_main_haircolor_name);
        //绑定事件监听器
        ...
        hairnametxt.setText("染发");

        //创建静态数据
        PrepareHairStylePicture hairStyles = new PrepareHairStylePicture();
        mRecyclerView = findViewById(R.id.user_main_haircolor_recyclerview);
        //设置布局管理器为2列，纵向
    ...
    private void initAdapter() {
        mAdapter = new HaircolorRecyclerviewAdapter(this, R.layout.item_user_main_haircolor_recyclerview, colorlist);
