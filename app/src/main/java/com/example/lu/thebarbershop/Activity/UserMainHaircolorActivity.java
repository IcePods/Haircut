...
public class UserMainHaircolorActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new HaircolorRecyclerviewAdapter(this, R.layout.item_user_main_haircolor_recyclerview, hairStyles.prepareHairStylePicture()); mRecyclerView.setLayoutManager(mLayoutManager);
