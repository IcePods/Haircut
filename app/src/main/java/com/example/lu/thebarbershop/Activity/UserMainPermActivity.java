...
import com.example.lu.thebarbershop.Adapter.PermRecyclerviewAdapter;
...
public class UserMainPermActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /* Log.i("perms",permsList.size()+"");*/
        ...
        hairnametxt = findViewById(R.id.user_main_perm_name);
        //绑定事件监听器
    ...
    private void initAdapter() {
        ...
        mAdapter.setItemClickListener(new PermRecyclerviewAdapter.MyItemClickListener(){
            @Override
