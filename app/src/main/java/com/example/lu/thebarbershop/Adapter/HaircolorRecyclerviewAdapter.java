...
public class HaircolorRecyclerviewAdapter extends RecyclerView.Adapter{
    private Context mContext;
    private int mLayout;
    private List<HairStyle> hairs;
    private MyItemClickListener mItemClickListener;

    public HaircolorRecyclerviewAdapter(Context mContext, int mLayout, List<HairStyle> hairs) {
...
//            simpleDraweeView = (SimpleDraweeView) itemView.findViewById(R.id.user_main_perm_simpledraweeview);
            hairstyleimg = itemView.findViewById(R.id.user_main_haircolor_img);
            hairstylename = itemView.findViewById(R.id.user_main_haircolor_hairstylename);
